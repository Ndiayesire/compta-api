/** Schéma Swagger pour la réponse `POST /op-royalties/import`. */
export const OP_ROYALTY_IMPORT_RESPONSE_SCHEMA = {
  type: 'object' as const,
  properties: {
    success: { type: 'boolean' as const, example: true },
    message: {
      type: 'string' as const,
      example: 'Import redevances : 2 créé(s), 0 ligne(s) en erreur',
    },
    data: {
      type: 'object' as const,
      properties: {
        ...
        created: {
          type: 'array' as const,
          description: 'Redevances créées (tier inclus)',
